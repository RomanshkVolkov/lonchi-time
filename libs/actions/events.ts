...
import { handleActionError, printErrorsOnDevEnv } from '../serializers/error-handler';
...
export async function createEventAction(
   ...
   const data = Object.fromEntries(formData.entries()) as Record<EventFieldTypes, string>;
